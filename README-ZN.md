...
<b align="center">Last updated: 2019-04-29</b>
...
| 5 | [最长回文子串](https://leetcode.com/ploblems/longest-palindromic-substring)| Medium | [python](./5-longest-palindromic-substring/longest-palindromic-substring.python.py) [python3](./5-longest-palindromic-substring/longest-palindromic-substring.python3.py) |
...
| 8 | [字符串转换整数 (atoi)](https://leetcode.com/ploblems/string-to-integer-atoi)| Medium | [python3](./8-string-to-integer-atoi/string-to-integer-atoi.python3.py) [python](./8-string-to-integer-atoi/string-to-integer-atoi.python.py) |
...
| 20 | [有效的括号](https://leetcode.com/ploblems/valid-parentheses)| Easy | [python](./20-valid-parentheses/valid-parentheses.python.py) [python3](./20-valid-parentheses/valid-parentheses.python3.py) |
| 21 | [合并两个有序链表](https://leetcode.com/ploblems/merge-two-sorted-lists)| Easy | [python](./21-merge-two-sorted-lists/merge-two-sorted-lists.python.py) [python3](./21-merge-two-sorted-lists/merge-two-sorted-lists.python3.py) |
| 22 | [括号生成](https://leetcode.com/ploblems/generate-parentheses)| Medium | [python3](./22-generate-parentheses/generate-parentheses.python3.py) [python](./22-generate-parentheses/generate-parentheses.python.py) |
| 23 | [合并K个排序链表](https://leetcode.com/ploblems/merge-k-sorted-lists)| Hard | [python](./23-merge-k-sorted-lists/merge-k-sorted-lists.python.py) [python3](./23-merge-k-sorted-lists/merge-k-sorted-lists.python3.py) |
| 24 | [两两交换链表中的节点](https://leetcode.com/ploblems/swap-nodes-in-pairs)| Medium | [python](./24-swap-nodes-in-pairs/swap-nodes-in-pairs.python.py) [python3](./24-swap-nodes-in-pairs/swap-nodes-in-pairs.python3.py) |
...
| 46 | [全排列](https://leetcode.com/ploblems/permutations)| Medium | [python3](./46-permutations/permutations.python3.py) [python](./46-permutations/permutations.python.py) |
...
| 59 | [螺旋矩阵 II](https://leetcode.com/ploblems/spiral-matrix-ii)| Medium | [python](./59-spiral-matrix-ii/spiral-matrix-ii.python.py) [python3](./59-spiral-matrix-ii/spiral-matrix-ii.python3.py) |
| 62 | [不同路径](https://leetcode.com/ploblems/unique-paths)| Medium | [python3](./62-unique-paths/unique-paths.python3.py) [python](./62-unique-paths/unique-paths.python.py) |
| 63 | [不同路径 II](https://leetcode.com/ploblems/unique-paths-ii)| Medium | [python3](./63-unique-paths-ii/unique-paths-ii.python3.py) |
| 64 | [最小路径和](https://leetcode.com/ploblems/minimum-path-sum)| Medium | [python](./64-minimum-path-sum/minimum-path-sum.python.py) [python3](./64-minimum-path-sum/minimum-path-sum.python3.py) |
...
| 69 | [x 的平方根](https://leetcode.com/ploblems/sqrtx)| Easy | [python](./69-sqrtx/sqrtx.python.py) [python3](./69-sqrtx/sqrtx.python3.py) |
...
| 88 | [合并两个有序数组](https://leetcode.com/ploblems/merge-sorted-array)| Easy | [python](./88-merge-sorted-array/merge-sorted-array.python.py) [python3](./88-merge-sorted-array/merge-sorted-array.python3.py) |
...
| 98 | [验证二叉搜索树](https://leetcode.com/ploblems/validate-binary-search-tree)| Medium | [python3](./98-validate-binary-search-tree/validate-binary-search-tree.python3.py) [python](./98-validate-binary-search-tree/validate-binary-search-tree.python.py) |
| 100 | [相同的树](https://leetcode.com/ploblems/same-tree)| Easy | [python](./100-same-tree/same-tree.python.py) |
| 101 | [对称二叉树](https://leetcode.com/ploblems/symmetric-tree)| Easy | [python3](./101-symmetric-tree/symmetric-tree.python3.py) [python](./101-symmetric-tree/symmetric-tree.python.py) |
| 102 | [二叉树的层次遍历](https://leetcode.com/ploblems/binary-tree-level-order-traversal)| Medium | [python3](./102-binary-tree-level-order-traversal/binary-tree-level-order-traversal.python3.py) [python](./102-binary-tree-level-order-traversal/binary-tree-level-order-traversal.python.py) |
| 104 | [二叉树的最大深度](https://leetcode.com/ploblems/maximum-depth-of-binary-tree)| Easy | [python](./104-maximum-depth-of-binary-tree/maximum-depth-of-binary-tree.python.py) [python3](./104-maximum-depth-of-binary-tree/maximum-depth-of-binary-tree.python3.py) [java](./104-maximum-depth-of-binary-tree/maximum-depth-of-binary-tree.java.java) |
| 105 | [从前序与中序遍历序列构造二叉树](https://leetcode.com/ploblems/construct-binary-tree-from-preorder-and-inorder-traversal)| Medium | [python3](./105-construct-binary-tree-from-preorder-and-inorder-traversal/construct-binary-tree-from-preorder-and-inorder-traversal.python3.py) [python](./105-construct-binary-tree-from-preorder-and-inorder-traversal/construct-binary-tree-from-preorder-and-inorder-traversal.python.py) |
...
| 109 | [有序链表转换二叉搜索树](https://leetcode.com/ploblems/convert-sorted-list-to-binary-search-tree)| Medium | [python](./109-convert-sorted-list-to-binary-search-tree/convert-sorted-list-to-binary-search-tree.python.py) [python3](./109-convert-sorted-list-to-binary-search-tree/convert-sorted-list-to-binary-search-tree.python3.py) |
...
| 118 | [杨辉三角](https://leetcode.com/ploblems/pascals-triangle)| Easy | [golang](./118-pascals-triangle/pascals-triangle.golang.) [python3](./118-pascals-triangle/pascals-triangle.python3.py) |
...
| 120 | [三角形最小路径和](https://leetcode.com/ploblems/triangle)| Medium | [python3](./120-triangle/triangle.python3.py) [python](./120-triangle/triangle.python.py) |
...
| 129 | [求根到叶子节点数字之和](https://leetcode.com/ploblems/sum-root-to-leaf-numbers)| Medium | [python](./129-sum-root-to-leaf-numbers/sum-root-to-leaf-numbers.python.py) [python3](./129-sum-root-to-leaf-numbers/sum-root-to-leaf-numbers.python3.py) |
| 131 | [分割回文串](https://leetcode.com/ploblems/palindrome-partitioning)| Medium | [python](./131-palindrome-partitioning/palindrome-partitioning.python.py) [python3](./131-palindrome-partitioning/palindrome-partitioning.python3.py) |
...
| 144 | [二叉树的前序遍历](https://leetcode.com/ploblems/binary-tree-preorder-traversal)| Medium | [python](./144-binary-tree-preorder-traversal/binary-tree-preorder-traversal.python.py) [python3](./144-binary-tree-preorder-traversal/binary-tree-preorder-traversal.python3.py) |
| 145 | [二叉树的后序遍历](https://leetcode.com/ploblems/binary-tree-postorder-traversal)| Hard | [python](./145-binary-tree-postorder-traversal/binary-tree-postorder-traversal.python.py) [python3](./145-binary-tree-postorder-traversal/binary-tree-postorder-traversal.python3.py) |
...
| 206 | [反转链表](https://leetcode.com/ploblems/reverse-linked-list)| Easy | [python3](./206-reverse-linked-list/reverse-linked-list.python3.py) [python](./206-reverse-linked-list/reverse-linked-list.python.py) |
| 208 | [实现 Trie (前缀树)](https://leetcode.com/ploblems/implement-trie-prefix-tree)| Medium | [python3](./208-implement-trie-prefix-tree/implement-trie-prefix-tree.python3.py) |
...
| 216 | [组合总和 III](https://leetcode.com/ploblems/combination-sum-iii)| Medium | [python3](./216-combination-sum-iii/combination-sum-iii.python3.py) [python](./216-combination-sum-iii/combination-sum-iii.python.py) |
| 217 | [存在重复元素](https://leetcode.com/ploblems/contains-duplicate)| Easy | [python3](./217-contains-duplicate/contains-duplicate.python3.py) [python](./217-contains-duplicate/contains-duplicate.python.py) |
| 226 | [翻转二叉树](https://leetcode.com/ploblems/invert-binary-tree)| Easy | [python](./226-invert-binary-tree/invert-binary-tree.python.py) |
| 230 | [二叉搜索树中第K小的元素](https://leetcode.com/ploblems/kth-smallest-element-in-a-bst)| Medium | [python3](./230-kth-smallest-element-in-a-bst/kth-smallest-element-in-a-bst.python3.py) [python](./230-kth-smallest-element-in-a-bst/kth-smallest-element-in-a-bst.python.py) |
...
| 234 | [回文链表](https://leetcode.com/ploblems/palindrome-linked-list)| Easy | [python](./234-palindrome-linked-list/palindrome-linked-list.python.py) [python3](./234-palindrome-linked-list/palindrome-linked-list.python3.py) |
...
| 257 | [二叉树的所有路径](https://leetcode.com/ploblems/binary-tree-paths)| Easy | [python3](./257-binary-tree-paths/binary-tree-paths.python3.py) [python](./257-binary-tree-paths/binary-tree-paths.python.py) |
...
| 278 | [第一个错误的版本](https://leetcode.com/ploblems/first-bad-version)| Easy | [python](./278-first-bad-version/first-bad-version.python.py) [python3](./278-first-bad-version/first-bad-version.python3.py) |
| 283 | [移动零](https://leetcode.com/ploblems/move-zeroes)| Easy | [python](./283-move-zeroes/move-zeroes.python.py) [python3](./283-move-zeroes/move-zeroes.python3.py) |
| 284 | [顶端迭代器](https://leetcode.com/ploblems/peeking-iterator)| Medium | [python](./284-peeking-iterator/peeking-iterator.python.py) [python3](./284-peeking-iterator/peeking-iterator.python3.py) |
...
| 345 | [反转字符串中的元音字母](https://leetcode.com/ploblems/reverse-vowels-of-a-string)| Easy | [python3](./345-reverse-vowels-of-a-string/reverse-vowels-of-a-string.python3.py) [python](./345-reverse-vowels-of-a-string/reverse-vowels-of-a-string.python.py) |
...
| 350 | [两个数组的交集 II](https://leetcode.com/ploblems/intersection-of-two-arrays-ii)| Easy | [python](./350-intersection-of-two-arrays-ii/intersection-of-two-arrays-ii.python.py) [python3](./350-intersection-of-two-arrays-ii/intersection-of-two-arrays-ii.python3.py) |
...
| 374 | [猜数字大小](https://leetcode.com/ploblems/guess-number-higher-or-lower)| Easy | [python](./374-guess-number-higher-or-lower/guess-number-higher-or-lower.python.py) [java](./374-guess-number-higher-or-lower/guess-number-higher-or-lower.java.java) |
...
| 384 | [打乱数组](https://leetcode.com/ploblems/shuffle-an-array)| Medium | [python3](./384-shuffle-an-array/shuffle-an-array.python3.py) [python](./384-shuffle-an-array/shuffle-an-array.python.py) |
| 387 | [字符串中的第一个唯一字符](https://leetcode.com/ploblems/first-unique-character-in-a-string)| Easy | [python3](./387-first-unique-character-in-a-string/first-unique-character-in-a-string.python3.py) [python](./387-first-unique-character-in-a-string/first-unique-character-in-a-string.python.py) |
...
| 404 | [左叶子之和](https://leetcode.com/ploblems/sum-of-left-leaves)| Easy | [python](./404-sum-of-left-leaves/sum-of-left-leaves.python.py) [python3](./404-sum-of-left-leaves/sum-of-left-leaves.python3.py) |
...
| 448 | [找到所有数组中消失的数字](https://leetcode.com/ploblems/find-all-numbers-disappeared-in-an-array)| Easy | [python](./448-find-all-numbers-disappeared-in-an-array/find-all-numbers-disappeared-in-an-array.python.py) [python3](./448-find-all-numbers-disappeared-in-an-array/find-all-numbers-disappeared-in-an-array.python3.py) |
...
| 515 | [在每个树行中找最大值](https://leetcode.com/ploblems/find-largest-value-in-each-tree-row)| Medium | [python](./515-find-largest-value-in-each-tree-row/find-largest-value-in-each-tree-row.python.py) [python3](./515-find-largest-value-in-each-tree-row/find-largest-value-in-each-tree-row.python3.py) |
| 521 | [最长特殊序列 Ⅰ](https://leetcode.com/ploblems/longest-uncommon-subsequence-i)| Easy | [python3](./521-longest-uncommon-subsequence-i/longest-uncommon-subsequence-i.python3.py) [python](./521-longest-uncommon-subsequence-i/longest-uncommon-subsequence-i.python.py) |
...
| 566 | [重塑矩阵](https://leetcode.com/ploblems/reshape-the-matrix)| Easy | [python](./566-reshape-the-matrix/reshape-the-matrix.python.py) |
...
| 677 | [键值映射](https://leetcode.com/ploblems/map-sum-pairs)| Medium | [python](./677-map-sum-pairs/map-sum-pairs.python.py) [python3](./677-map-sum-pairs/map-sum-pairs.python3.py) |
...
| 695 | [岛屿的最大面积](https://leetcode.com/ploblems/max-area-of-island)| Medium | [python3](./695-max-area-of-island/max-area-of-island.python3.py) [python](./695-max-area-of-island/max-area-of-island.python.py) |
...
| 728 | [自除数](https://leetcode.com/ploblems/self-dividing-numbers)| Easy | [python3](./728-self-dividing-numbers/self-dividing-numbers.python3.py) [python](./728-self-dividing-numbers/self-dividing-numbers.python.py) |
...
| 763 | [划分字母区间](https://leetcode.com/ploblems/partition-labels)| Medium | [python3](./763-partition-labels/partition-labels.python3.py) [python](./763-partition-labels/partition-labels.python.py) |
...
| 700 | [二叉搜索树中的搜索](https://leetcode.com/ploblems/search-in-a-binary-search-tree)| Easy | [python](./700-search-in-a-binary-search-tree/search-in-a-binary-search-tree.python.py) [python3](./700-search-in-a-binary-search-tree/search-in-a-binary-search-tree.python3.py) |
| 701 | [二叉搜索树中的插入操作](https://leetcode.com/ploblems/insert-into-a-binary-search-tree)| Medium | [python3](./701-insert-into-a-binary-search-tree/insert-into-a-binary-search-tree.python3.py) [python](./701-insert-into-a-binary-search-tree/insert-into-a-binary-search-tree.python.py) |
| 789 | [逃脱阻碍者](https://leetcode.com/ploblems/escape-the-ghosts)| Medium | [python3](./789-escape-the-ghosts/escape-the-ghosts.python3.py) [python](./789-escape-the-ghosts/escape-the-ghosts.python.py) |
| 791 | [自定义字符串排序](https://leetcode.com/ploblems/custom-sort-string)| Medium | [python3](./791-custom-sort-string/custom-sort-string.python3.py) [python](./791-custom-sort-string/custom-sort-string.python.py) |
| 797 | [所有可能的路径](https://leetcode.com/ploblems/all-paths-from-source-to-target)| Medium | [python](./797-all-paths-from-source-to-target/all-paths-from-source-to-target.python.py) [python3](./797-all-paths-from-source-to-target/all-paths-from-source-to-target.python3.py) |
...
| 807 | [保持城市天际线](https://leetcode.com/ploblems/max-increase-to-keep-city-skyline)| Medium | [python3](./807-max-increase-to-keep-city-skyline/max-increase-to-keep-city-skyline.python3.py) [python](./807-max-increase-to-keep-city-skyline/max-increase-to-keep-city-skyline.python.py) |
...
| 812 | [最大三角形面积](https://leetcode.com/ploblems/largest-triangle-area)| Easy | [python](./812-largest-triangle-area/largest-triangle-area.python.py) [python3](./812-largest-triangle-area/largest-triangle-area.python3.py) |
| 814 | [二叉树剪枝](https://leetcode.com/ploblems/binary-tree-pruning)| Medium | [python3](./814-binary-tree-pruning/binary-tree-pruning.python3.py) [python](./814-binary-tree-pruning/binary-tree-pruning.python.py) |
| 821 | [字符的最短距离](https://leetcode.com/ploblems/shortest-distance-to-a-character)| Easy | [python](./821-shortest-distance-to-a-character/shortest-distance-to-a-character.python.py) [python3](./821-shortest-distance-to-a-character/shortest-distance-to-a-character.python3.py) |
...
| 832 | [翻转图像](https://leetcode.com/ploblems/flipping-an-image)| Easy | [python](./832-flipping-an-image/flipping-an-image.python.py) [python3](./832-flipping-an-image/flipping-an-image.python3.py) |
...
| 861 | [翻转矩阵后的得分](https://leetcode.com/ploblems/score-after-flipping-matrix)| Medium | [python3](./861-score-after-flipping-matrix/score-after-flipping-matrix.python3.py) [python](./861-score-after-flipping-matrix/score-after-flipping-matrix.python.py) |
...
| 872 | [叶子相似的树](https://leetcode.com/ploblems/leaf-similar-trees)| Easy | [python3](./872-leaf-similar-trees/leaf-similar-trees.python3.py) [python](./872-leaf-similar-trees/leaf-similar-trees.python.py) |
...
| 877 | [石子游戏](https://leetcode.com/ploblems/stone-game)| Medium | [python](./877-stone-game/stone-game.python.py) [python3](./877-stone-game/stone-game.python3.py) |
...
| 884 | [两句话中的不常见单词](https://leetcode.com/ploblems/uncommon-words-from-two-sentences)| Easy | [python3](./884-uncommon-words-from-two-sentences/uncommon-words-from-two-sentences.python3.py) [python](./884-uncommon-words-from-two-sentences/uncommon-words-from-two-sentences.python.py) |
...
| 893 | [特殊等价字符串组](https://leetcode.com/ploblems/groups-of-special-equivalent-strings)| Easy | [python](./893-groups-of-special-equivalent-strings/groups-of-special-equivalent-strings.python.py) [python3](./893-groups-of-special-equivalent-strings/groups-of-special-equivalent-strings.python3.py) |
| 905 | [按奇偶排序数组](https://leetcode.com/ploblems/sort-array-by-parity)| Easy | [python](./905-sort-array-by-parity/sort-array-by-parity.python.py) [python3](./905-sort-array-by-parity/sort-array-by-parity.python3.py) |
| 908 | [最小差值 I](https://leetcode.com/ploblems/smallest-range-i)| Easy | [python](./908-smallest-range-i/smallest-range-i.python.py) [python3](./908-smallest-range-i/smallest-range-i.python3.py) |
| 921 | [使括号有效的最少添加](https://leetcode.com/ploblems/minimum-add-to-make-parentheses-valid)| Medium | [python](./921-minimum-add-to-make-parentheses-valid/minimum-add-to-make-parentheses-valid.python.py) [python3](./921-minimum-add-to-make-parentheses-valid/minimum-add-to-make-parentheses-valid.python3.py) |
...
| 929 | [独特的电子邮件地址](https://leetcode.com/ploblems/unique-email-addresses)| Easy | [python3](./929-unique-email-addresses/unique-email-addresses.python3.py) [python](./929-unique-email-addresses/unique-email-addresses.python.py) |
...
| 944 | [删列造序](https://leetcode.com/ploblems/delete-columns-to-make-sorted)| Easy | [python](./944-delete-columns-to-make-sorted/delete-columns-to-make-sorted.python.py) [python3](./944-delete-columns-to-make-sorted/delete-columns-to-make-sorted.python3.py) |
...
| 961 | [重复 N 次的元素](https://leetcode.com/ploblems/n-repeated-element-in-size-2n-array)| Easy | [python](./961-n-repeated-element-in-size-2n-array/n-repeated-element-in-size-2n-array.python.py) [python3](./961-n-repeated-element-in-size-2n-array/n-repeated-element-in-size-2n-array.python3.py) |
...
| 966 | [元音拼写检查器](https://leetcode.com/ploblems/vowel-spellchecker)| Medium | [python](./966-vowel-spellchecker/vowel-spellchecker.python.py) [python3](./966-vowel-spellchecker/vowel-spellchecker.python3.py) |
| 967 | [连续差相同的数字](https://leetcode.com/ploblems/numbers-with-same-consecutive-differences)| Medium | [python](./967-numbers-with-same-consecutive-differences/numbers-with-same-consecutive-differences.python.py) [python3](./967-numbers-with-same-consecutive-differences/numbers-with-same-consecutive-differences.python3.py) |
| 968 | [监控二叉树](https://leetcode.com/ploblems/binary-tree-cameras)| Hard | [python](./968-binary-tree-cameras/binary-tree-cameras.python.py) [python3](./968-binary-tree-cameras/binary-tree-cameras.python3.py) |
| 970 | [强整数](https://leetcode.com/ploblems/powerful-integers)| Easy | [python3](./970-powerful-integers/powerful-integers.python3.py) |
| 509 | [斐波那契数](https://leetcode.com/ploblems/fibonacci-number)| Easy | [python](./509-fibonacci-number/fibonacci-number.python.py) [python3](./509-fibonacci-number/fibonacci-number.python3.py) |
...
| 1026 | [节点与其祖先之间的最大差值](https://leetcode.com/ploblems/maximum-difference-between-node-and-ancestor)| Medium | [python3](./1026-maximum-difference-between-node-and-ancestor/maximum-difference-between-node-and-ancestor.python3.py) |
